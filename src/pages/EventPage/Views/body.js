                        ...
                        return (
                            <TouchableOpacity key={itm.id} style={{ marginLeft: index > 0 ? 1 : 0, marginTop: 1, backgroundColor: "white", padding: 5 }} onPress={() => this.props.onItemPress(itm.id)}>
                                <View style={{ height: 150, width: 100 }}>
                                    ...
                                    <Text numberOfLines={2} style={{ fontSize: 12, color: '#f56a00', backgroundColor: "transparent" }}>{price.p !== '$null' ? price.p : '¥' + itm.ap.p.r}</Text>
                                    <Text numberOfLines={2} style={{ fontSize: 10, color: '#919191', backgroundColor: "transparent" }}>包邮价:{price.pi !== '$null' ? price.pi : '¥' + itm.ap.p.ri}</Text>
                                </View>
                            </TouchableOpacity>
                        )
                    })}
