...
class WithdrawToCNBank extends Component {
  componentDidMount() {
  ...
  render() {
    console.log("提现到境内银行页面的this.props", this.props);
    return (
      <Page>
        <View
          style={{
...
// 增加底部按钮
const wapprer = PageWithTab(WithdrawToCNBank, ["提交申请"], ["#f5222d"]);
